"""
backtest.replay — causal reversal-replay harness (moved from wavelib/backtest.py)
===========
...
from ..patterns import candidates as automation
from ..signals.confluence import score_reversal
from ..validation.stats import (sharpe_ratio, skew_kurt, probabilistic_sharpe_ratio,
