"""
patterns.candidates — auto-labeling + bottom-up degree assignment.
====================================================================
PRIMARY candidate path (docs/ARCHITECTURE.md D5): RuleResult-native, causal.
Moved verbatim from wavelib/automation.py.
...
from ..pivots.percentage_reversal import zigzag_causal, zigzag_multiscale
from ..rules import (RuleResult, Pivot, Status, Wave, elliott_hard_rules,
                     group_polywaves, label_monowaves, validate_correction,
                     validate_impulse)
