...
# =========================================================================== #
# PLATFORM STATUS (docs/ARCHITECTURE.md D6, docs/FORWARD_GHOST_TEST_FINDINGS.md):
# the next-leg forecast DIRECTION below is empirically edge-free (coin-flip on a
# year-long causal replay). It is REF/reference-only: reports may show it, but
# it must never gate an automated entry. The trade-management machinery
# (trade_plan: confirmation trigger, structural stop, R:R, confluence gate)
# remains load-bearing and is reused by the signal engine.
# =========================================================================== #

from __future__ import annotations
from dataclasses import dataclass

from ..patterns.candidates import swing_sequence
from ..patterns.tree import wave_counts
from ..rules import triangle_thrust
from ..rules.fib import fib_cluster, fib_retrace
